...
public class ThreadExample {
    ...
    public void example(String param) throws IOException {
        String clientId = "MSTnfNBugpWmfDv3DR6l";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "3ma2voE9by";//애플리케이션 클라이언트 시크릿값";
